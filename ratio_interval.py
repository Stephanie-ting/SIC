...
from mainfuncSIC_MAX_interval import EAOO_latest
...
if __name__ == '__main__':
    ...
    for i in range(len(interval)):
        ...
        # EAOO-SIC算法
        EAOOSIC_time, EAOOSIC_lantency, stop_time_sic,ratio_interval_list = EAOO_latest(N, n, E_min, P, E_i, D_i_list, f_i, g_i, wirelessDevices_, server_, B_, T_,interval_)


        sio.savemat('./ratio/interval_EAOOSIC_' + str(interval[i]) + '.mat',{'ratio_interval_list':ratio_interval_list})
