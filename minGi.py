...
if __name__ == '__main__':
    ...
    for lowdata in range(1, 6, 1):#      1 2 3 4 5
    ...
    save_to_txt(EAOOSIC_minData_latency_list, './minGi/EAOOSIC_minData_latency_list.txt')
    save_to_txt(EAOO_minData_latency_list, './minGi/EAOO_minData_latency_list.txt')
    save_to_txt(DROO_minData_latency_list, './minGi/DROO_minData_latency_list.txt')
    save_to_txt(local_minData_latency_list, './minGi/local_minData_latency_list.txt')
# coding=utf8
