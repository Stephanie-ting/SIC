...
def EAOO_latest_serial(N_, n_, E_min_, P_, E_i_, D_i_list_, f_i_, g_i_, B_=5, T_=2, Ps_=50):
...
if __name__ == "__main__":
    ...
    for N in range(10, 32, 2):
        ...
        # EAOO-串行
        EAOO_time, EAOO_lantency, stop_time = EAOO_latest_serial(N, n, E_min, P, E_i, D_i_list, f_i, g_i, B_, T_, Ps_)
