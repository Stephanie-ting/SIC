...
def EAOO_latest(N_, n_, E_min_, P_, E_i_, D_i_list_, f_i_, g_i_, wirelessDevices_, server_, B_=5, T_=2.0, batch=128):
    ...
    ratio_batch_list = []
    ratio_batch_list.append(rate_his_ratio)
    ...
    return total_time, totallantency_final, stop_time, ratio_batch_list