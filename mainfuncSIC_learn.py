...
def EAOO_latest(N_, n_, E_min_, P_, E_i_, D_i_list_, f_i_, g_i_, B_=5, T_=2, Ps_=50,lr_=1e-5):
    ...
    Memory = 256  # capacity of memory structure
    ...
    #print(memory_cost)
    learn_cost_list.append(memory_cost)
    #plot_rate(rate_his_ratio)

    print(N, '个 WDs',"算法停止的时间帧(0-2999):", stop_time)

    # print(stop_time + 1, "个时间帧的总时延是：", totallantency_final)
    return total_time, totallantency_final, stop_time, learn_cost_list
